...
_This is where I currently am in the project. The rest of the post is effectively a todo list/placeholder. Check back in the future!_

- UV issues
- More vertices near the door
- Door transition

### Detailing
- More windows where there should be windows
- Doors where there should be doors
- Doodads: supplies, fences, stables, maybe some outdoor Hearthstone tables 

### Showcase 
Just a neat showcase to end the post with. Place in the world? Scenescript? Maybe mess with some of the future ideas for funsies. 
