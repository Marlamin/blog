...
description: My biggest project yet! Giving the amazing Hearthstone Tavern interior model from 8.2.5 an exterior.
authors: marlamin
tags: [wow, world-of-warcraft, modding]
enableComments: true
image: https://marlam.in/u/Wow_saiE96M5R4.jpg
date: 2025-02-23
---
...
Both the tavern's main hall and fancy side room, [to my surprise](https://bsky.app/profile/marlam.in/post/3ldmex2gci22g), also appeared recently in the WoW comic "Seasons" ([YouTube](https://www.youtube.com/watch?v=AzIP04xEMrs), [PDF](https://bnetcmsus-a.akamaihd.net/cms/template_resource/TEFHLG7PQIL41734383405326.pdf)). In it, it is described as a secret place beyond Xal'atath's reach. While the frame before it appears to be in Stormwind, there's signs of a teleport happening to get to said place. Notably, except for a bartender in classic Bartender Bob apparel, there are no signs of Hearthstone. Curious. 
...
### "That door"
![https://marlam.in/u/chrome_3NK1qewWZC.png](https://marlam.in/u/chrome_3NK1qewWZC.png)
_"Beyond this hearth(-stone tavern), that door"_
...
In Blender:
<ReactPlayer controls url='https://marlam.in/u/blender_v5GD46f196.mp4' /><br />
In-game: <ReactPlayer controls url='https://marlam.in/u/Wow_W9gr1fAa9O.mp4'/>
...
<ReactPlayer controls url='https://marlam.in/u/Wow_M8NEBbJ8nW.mp4' /><br />
...
![https://marlam.in/u/Wow_2ZoxjPqTXz.png](https://marlam.in/u/Wow_2ZoxjPqTXz.png)
...
![https://marlam.in/u/blender_aaVZHVlL9a.png](https://marlam.in/u/blender_aaVZHVlL9a.png)

Yeah, there's no door knob, I know. I've hidden the door mesh [in the stairs](https://marlam.in/u/blender_PP10HrdCVa.png) until I need it in the future at which point I'll add a door knob doodad.
...
- [This atrocious door transition](https://marlam.in/u/Wow_q0QeXgBzhp.png), will need a bunch of modeling work as well as figuring out how real WMO lighting transitions work in WoW.
- [Ugly UVs](https://marlam.in/u/Wow_KXL5dkTipJ.png), frankly can not be bothered as this is tedious work I am not good enough yet.
...
I did a Twitch stream ([VOD available here](https://www.twitch.tv/videos/2376621550) or [here](https://www.youtube.com/watch?v=6CYv-bZL2OU) if the Twitch one expires) that goes into the process of working on the model and adds some world around the tavern (and a balcony above the entrance) that I'm pretty happy with, just as an impression.
Granted this is all very dodgy lore wise given the tavern's mysterious/ephemeral place, but it still adds some flavor that teases the imagination.

### Screenshots 
![https://marlam.in/u/Wow_bkPZKl8Psb.jpg](https://marlam.in/u/Wow_bkPZKl8Psb.jpg)
_The stable area with a random door in the back._  

![https://marlam.in/u/Wow_rsvX8gC5lm.jpg](https://marlam.in/u/Wow_rsvX8gC5lm.jpg)
_Ignore the broken mountain in the distance, it is my test map after all._  

![https://marlam.in/u/Wow_saiE96M5R4.jpg](https://marlam.in/u/Wow_saiE96M5R4.jpg)
_It started snowing!_

![https://marlam.in/u/Wow_fLb5VgXSOe.jpg](https://marlam.in/u/Wow_fLb5VgXSOe.jpg)
_The loading dock/break area that the door behind the bar leads to._

![https://marlam.in/u/Wow_Iy2rpvOR3T.jpg](https://marlam.in/u/Wow_Iy2rpvOR3T.jpg)
_The back is still fully modeled, albeit a bit boring. Maybe I'll add some stuff here in the future!_

### Video
Quick fly-around video of the exterior. Video bitrate isn't great, but you can get a pretty good idea of it. 
<iframe src="//www.youtube.com/embed/cdrqTGs3Fjs" frameborder="0" allowfullscreen="allowfullscreen" width="100%" height="500"></iframe>

### Release (v1)
![https://marlam.in/u/blender_TKIR23woe4.jpg](https://marlam.in/u/blender_TKIR23woe4.jpg)

#### Blender (3.4)
You can download the .blend file [here](https://marlam.in/u/hstavernextv1.zip) (~61MB ZIP). Note that the interior tavern model included is very broken and is only there for scale/scavenging for reasons mentioned earlier in the post.
...
#### WoW WMO
A WMO download for modern WoW (8.2.5+) is also available [here](https://marlam.in/u/hstavernextwmov1.zip). FileDataID wise the WMO expects `8xp_hearthstonetavern_003.wmo` (the new exterior group) to have FileDataID `929010716` and `purple_roof_trim.blp` to have FileDataID `929010715`. The other files need to overwrite the existing Hearthstone Tavern files.
